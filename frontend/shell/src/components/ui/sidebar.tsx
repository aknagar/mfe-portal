  ...
  (
      ...
      return (
        <>
          ...
          <div
            ref={ref}
            className={cn(
              "fixed inset-y-0 z-50 hidden h-svh w-[--sidebar-width-mobile] flex-col border-r bg-sidebar text-sidebar-foreground transition-transform duration-200 ease-in-out lg:hidden",
    ...
    return (
      <div
        ...
        className={cn(
          "group relative hidden h-svh w-[--sidebar-width] flex-col border-r bg-sidebar text-sidebar-foreground lg:flex",
