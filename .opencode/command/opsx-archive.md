...
4. **Assess delta spec sync state**
   ...
   **Prompt options:**
   ...
   - If already synced: "Archive now", "Sync anyway", "Cancel"
    ...
    > **Note**: The `openspec-sync-specs` skill is not available in this installation (it was not generated by `openspec init`). If the user chooses sync, perform the merge manually: read each delta spec and apply its changes directly to the corresponding main spec file. Proceed to archive regardless of choice.
...
- If sync is requested, perform the merge manually (openspec-sync-specs skill is not available in this installation — see step 4 note)
